...
export function SubscriptionFilesPage() {
  ...
  const displayedAbsolutePath = useMemo(
    () => (selectedSiteId ? absoluteCurrentPath : ensureTrailingBackslash(subscriptionRootPath)),
        ...
        >
          ...
          {loadingBrowser ? (
            ...
            <div className="files-workbench__files-area">
              <div className="files-workbench__sort-bar">
                      ...
                      <div className="files-workbench__card-actions">
                        {entry.entryType === "directory" ? (
                          <button
                            ...
                            disabled={busyAction !== null}
                            title={t("Open folder", "Open folder")}
                          >
                            {t("Open", "Open")}
                          </button>
                        ) : (
